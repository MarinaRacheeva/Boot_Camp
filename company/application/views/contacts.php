...
if (($_SERVER["REQUEST_METHOD"] == "POST") && ($mail)){
    header('Refresh: 5; URL=' . $_SERVER["REQUEST_URI"]);
    if (($_SERVER["REQUEST_METHOD"] == "POST") && (!$mail))
        echo '<h1 align="center"><font color="red">Ошибка отправки сообщения</font></h1>';
    elseif (($_SERVER["REQUEST_METHOD"] == "POST") && ($mail))
        echo '<h1 align="center"><font color="purple">Благодарим за ваше письмо! Мы свяжемся с вами в ближайшее время.</font></h1>'; 
}
